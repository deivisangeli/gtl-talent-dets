...
data_full <- read_csv("Output/us_panel_county.csv", show_col_types = FALSE)
...
# Saving Results
###############################################################################
#dir.create("Results County", showWarnings = FALSE)
ggsave("Results County/treatment_map.png",      plot = plot_treatment,
       width = 8, height = 6, dpi = 300)
ggsave("Results County/density.png",            plot = plot_decade_density_all,
       width = 8, height = 6, dpi = 300)
ggsave("Results County/ES_county_full_std.png", plot = decade_50_std,
       width = 8, height = 6, dpi = 300)
ggsave("Results County/ES_county_full_alt.png", plot = decade_50_alt,
       width = 8, height = 6, dpi = 300)
ggsave("Results County/ES_county_sel_std.png",  plot = es_alt_facilities_std,
       width = 8, height = 6, dpi = 300)
ggsave("Results County/ES_county_sel_alt.png",  plot = es_alt_facilities_alt,
       width = 8, height = 6, dpi = 300)
ggsave("Results County/plot_means.png",         plot = plot_means_full,
       width = 8, height = 6, dpi = 300)
ggsave("Results County/plot_means_focus.png",   plot = plot_means_focus,
       width = 8, height = 6, dpi = 300)

ggsave("Results County/plot_fermilab.png",   plot = weston_es,
       width = 8, height = 6, dpi = 300)

ggsave("Results County/plot_fermilab_bordercounties.png",   plot = weston_border_es,
       width = 8, height = 6, dpi = 300)
