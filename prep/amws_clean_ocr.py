...
def main():
    input_file = Path('C:/Users/deivi/github/elite-schools/prep/output/amws_1955_batches/in/01301.tsv')
    output_file = Path('C:/Users/deivi/github/elite-schools/prep/output/amws_1955_batches/out/01301.jsonl')
