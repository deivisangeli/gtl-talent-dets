...
write_csv(county_treatment, "results/elite_school_county_treatment.csv")
...
write_csv(att_summary, "results/elite_stem_share_att_summary.csv")
write_csv(dyn_any, "results/elite_stem_share_dynamic_any.csv")
write_csv(bind_rows(dyn_high, dyn_low), "results/elite_stem_share_dynamic_high_low.csv")
...
ggsave("results/elite_stem_share_any_dynamic.png", plot_any,
       width = 8, height = 5.5, dpi = 300)
ggsave("results/elite_stem_share_high_low_dynamic.png", plot_high_low,
       width = 8, height = 5.5, dpi = 300)
...
sink("results/elite_stem_share_summary.txt")
...
cat("Elite-school STEM-share analysis complete. Outputs written to analysis/results/.\n")
