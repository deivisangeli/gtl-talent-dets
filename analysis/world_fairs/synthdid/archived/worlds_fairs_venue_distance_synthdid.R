...
#   Rscript analysis/world_fairs/synthdid/archived/worlds_fairs_venue_distance_synthdid.R
###############################################################################
...
run_worlds_fairs_synthdid(
  ...
  results_subdir = file.path(
    "archived",
    "worlds_fairs_uk_us_venue_distance_synthdid_with_london_events_1840_1910"
  ),
  repo_root = repo_root
)
