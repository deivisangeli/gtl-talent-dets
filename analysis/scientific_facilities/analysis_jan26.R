...
# Saving Outputs
###############################################################################
ggsave(filename = file.path(RESULTS_DIR, "ES_dynamic_annual.png"),plot= p_es_yearly, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "ES_dynamic_decade.png"),plot = p_es_decade, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "ES_dynamic_decade_alt.png"), plot = p_es_decade_alt,
       width = 8, height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "ggdid_decade.png"), plot = p_ggdid_dec, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "ggdid_decade_alt.png"),plot = p_ggdid_dec_alt, width = 8,
       height = 6, dpi = 300)
