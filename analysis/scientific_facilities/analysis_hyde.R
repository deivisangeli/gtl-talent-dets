...
for (radius_km in c(100, 200)) {
 ...
 # Saving
 ###############################################################################
 ggsave(filename = paste0(file.path(RESULTS_DIR, "ES_all_"),     suffix, ".png"), plot = plot_all,  width = 8, height = 6, dpi = 300)
 ggsave(filename = paste0(file.path(RESULTS_DIR, "ES_us_"),      suffix, ".png"), plot = plot_us,   width = 8, height = 6, dpi = 300)
 ggsave(filename = paste0(file.path(RESULTS_DIR, "ES_ussr_"),    suffix, ".png"), plot = plot_ussr, width = 8, height = 6, dpi = 300)
 ggsave(filename = paste0(file.path(RESULTS_DIR, "ES_westeur_"), suffix, ".png"), plot = plot_west, width = 8, height = 6, dpi = 300)
