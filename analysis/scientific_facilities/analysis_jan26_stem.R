...
# Save outputs
###############################################################################
ggsave(file.path(RESULTS_DIR, "stem_ES_dynamic_annual.png"),      p_es_yearly,     width=8, height=6, dpi=300)
ggsave(file.path(RESULTS_DIR, "stem_ES_dynamic_decade.png"),      p_es_decade,     width=8, height=6, dpi=300)
ggsave(file.path(RESULTS_DIR, "stem_ES_dynamic_decade_alt.png"),  p_es_decade_alt, width=8, height=6, dpi=300)
ggsave(file.path(RESULTS_DIR, "stem_ggdid_decade.png"),           p_ggdid_dec,     width=8, height=6, dpi=300)
ggsave(file.path(RESULTS_DIR, "stem_ggdid_decade_alt.png"),       p_ggdid_dec_alt, width=8, height=6, dpi=300)
ggsave(file.path(RESULTS_DIR, "stem_sanity_check.png"),           p_sanity,        width=8, height=6, dpi=300)
