...
RESULTS_DIR <- file.path(TALENT_DETS_DATA_DIR, "results", "scientific_facilities")
...
stargazer(
  ...
  out = file.path(RESULTS_DIR, "stem_descriptive_statistics.txt")
)

###############################################################################
# Save figures
###############################################################################
ggsave(file.path(RESULTS_DIR, "stem_plot_absolute.png"),   plot_stem_abs,          width = 9, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_plot_rate.png"),       plot_stem_rate,         width = 9, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_plot_share.png"),      plot_stem_share,        width = 9, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_ukraine_absolute.png"), plot_stem_ukraine_abs, width = 9, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_ukraine_rate.png"),    plot_stem_ukraine_rate, width = 9, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_ussr_rate.png"),       plot_stem_ussr,         width = 9, height = 6, dpi = 300)

# Event-study plots
ggsave(file.path(RESULTS_DIR, "stem_es_west_abs.png"),       p_west_stem,           width = 8, height = 5, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_es_east_ussr_abs.png"),  p_east_ussr_stem,      width = 8, height = 5, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_es_east_non_abs.png"),   p_east_non_stem,       width = 8, height = 5, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_es_west_rate.png"),      p_west_stem_rate,      width = 8, height = 5, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_es_east_ussr_rate.png"), p_east_ussr_stem_rate, width = 8, height = 5, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_es_east_non_rate.png"),  p_east_non_stem_rate,  width = 8, height = 5, dpi = 300)

###############################################################################
# Model output
###############################################################################
sink(file.path(RESULTS_DIR, "stem_model_ussr.txt"))
...
sink(file.path(RESULTS_DIR, "stem_model_staggered.txt"))
