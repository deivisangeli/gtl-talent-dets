...
ggsave(file.path(RESULTS_DIR, "stem_treatment_map.png"),         plot_treatment,         width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_density.png"),               plot_density,           width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_ES_county_full_std.png"),    stem_decade_std,        width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_ES_county_full_alt.png"),    stem_decade_alt,        width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_ES_county_sel_std.png"),     stem_alt_facilities_std, width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_ES_county_sel_alt.png"),     stem_alt_facilities_alt, width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_plot_means.png"),            plot_means_full,        width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_plot_means_focus.png"),      plot_means_focus,       width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_fermilab_ES.png"),           weston_es,              width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_fermilab_ts.png"),           p_weston_ts,            width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "stem_fermilab_border_ES.png"),    weston_border_es,       width = 8, height = 6, dpi = 300)
