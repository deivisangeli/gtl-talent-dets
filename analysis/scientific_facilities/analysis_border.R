...
# Saving Results
###############################################################################
ggsave(file.path(RESULTS_DIR, "treatment_map.png"),      plot = plot_treatment,
       width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "density.png"),            plot = plot_decade_density_all,
       width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "ES_county_full_std.png"), plot = decade_50_std,
       width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "ES_county_full_alt.png"), plot = decade_50_alt,
       width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "ES_county_sel_std.png"),  plot = es_alt_facilities_std,
       width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "ES_county_sel_alt.png"),  plot = es_alt_facilities_alt,
       width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "plot_means.png"),         plot = plot_means_full,
       width = 8, height = 6, dpi = 300)
ggsave(file.path(RESULTS_DIR, "plot_means_focus.png"),   plot = plot_means_focus,
       width = 8, height = 6, dpi = 300)

ggsave(file.path(RESULTS_DIR, "plot_fermilab.png"),   plot = weston_es,
       width = 8, height = 6, dpi = 300)

ggsave(file.path(RESULTS_DIR, "plot_fermilab_bordercounties.png"),   plot = weston_border_es,
       width = 8, height = 6, dpi = 300)
