...
# Uploading databases
###############################################################################
# NOTE: us_panel_fixed.csv is a HYDE cell-level US panel generated by
# prep/scientific_facilities/cleaning_us.R
# It requires HYDE raster files (prep/input/hyde_pop_asc/) — see CLAUDE.md
data_full <- read_csv(file.path(DATA_OUTPUT, "us_panel_fixed.csv"), show_col_types = FALSE)
...
# Saving Results
###############################################################################
ggsave(filename = file.path(RESULTS_DIR, "treatment_map.png"), plot=plot_treatment, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "density.png"), plot= plot_decade_density_all, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "ES_US_full_std.png"), plot= decade_50_std, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "ES_US_full_alt.png"), plot= decade_50_alt, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "ES_US_selected_std.png"), plot= es_alt_facilities_std, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "ES_US_selected_alt.png"), plot= es_alt_facilities_alt, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "plot_means.png"), plot= plot_means_full, width = 8,
       height = 6, dpi = 300)

ggsave(filename = file.path(RESULTS_DIR, "plot_means_focus.png"), plot= plot_means_focus, width = 8,
       height = 6, dpi = 300)
