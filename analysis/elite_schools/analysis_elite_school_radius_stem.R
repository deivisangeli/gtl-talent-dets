...
results_dir <- file.path(TALENT_DETS_DATA_DIR, "results", "elite_schools", "elite_school_radius50_legacy")
...
write_csv(radius_treatment, file.path(results_dir, "elite_radius50_treatment.csv"))
...
write_csv(att_summary,  file.path(results_dir, "elite_radius50_att_summary.csv"))
write_csv(dynamic_tbl,  file.path(results_dir, "elite_radius50_dynamic.csv"))
write_csv(pretrend_leads, file.path(results_dir, "elite_radius50_pretrend_leads.csv"))
...
ggsave(file.path(results_dir, "elite_radius50_any_dynamic.png"), plot_any,
       width = 8.5, height = 10, dpi = 300)
ggsave(file.path(results_dir, "elite_radius50_high_low_dynamic.png"), plot_high_low,
       width = 8.5, height = 10, dpi = 300)
...
sink(file.path(results_dir, "elite_radius50_summary.txt"))
...
cat("Elite-school 50 km analysis complete. Outputs written to Dropbox results/elite_schools/.\n")
