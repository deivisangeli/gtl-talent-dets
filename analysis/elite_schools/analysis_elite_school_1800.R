...
outcomes <- list(
  list(var = "stem_within_notable_pct_zero", label = "STEM share zero-filled (pp)"),
  list(var = "stem_within_notable_pct_smooth", label = "STEM share smoothed (pp)"),
