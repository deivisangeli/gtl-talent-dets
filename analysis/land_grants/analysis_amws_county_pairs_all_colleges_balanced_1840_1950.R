...
# - county-decade AMWS panel balanced over 1840-1950
# - treatment cohorts 1880-1910
# - at least four pre-treatment and four post-treatment decades
...
results_subdir <- "amws_county_pairs_all_colleges_balanced_1840_1950"

control_group <- "nevertreated"
est_method <- "dr"
analysis_min_decade <- 1840L
analysis_max_decade <- 1950L
treatment_min_cohort <- 1880L
treatment_max_cohort <- 1910L
pre_event_window <- 40L
