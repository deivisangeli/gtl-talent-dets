...
ggsave(
 filename = results_file_path("land_grants", "county_pairs_treatment_map.png"),
 plot = plot_treatment,
 width = 8,
 height = 6,
 dpi = 300
...
notes_path <- results_file_path("land_grants", "county_pairs_treatment_map_notes.txt")
notes_lines <- c(
...
message("Saved map to: ", results_file_path("land_grants", "county_pairs_treatment_map.png"))
