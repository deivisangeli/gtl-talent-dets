...
runner_unresolved_rows <- pairs_long %>%
 filter(experiment_year >= 1870, !runner_up_match_status %in% c("matched_same_state", "matched_cross_state")) %>%
...
ggsave(
 filename = results_file_path("land_grants", "ES_county_pairs_std.png"),
 plot = es_std$plot,
 width = 8,
 height = 6,
 dpi = 300
...
ggsave(
 filename = results_file_path("land_grants", "ES_county_pairs_alt.png"),
 plot = es_shift$plot,
 width = 8,
 height = 6,
 dpi = 300
...
ggsave(
 filename = results_file_path("land_grants", "ggdid_county_pairs_std.png"),
 plot = plot_ggdid_std,
 width = 8,
 height = 6,
 dpi = 300
...
ggsave(
 filename = results_file_path("land_grants", "ggdid_county_pairs_alt.png"),
...
writeLines(summary_lines, con = results_file_path("land_grants", "county_pairs_es_sample.txt"))
